<x-tenant-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block w-full px-4 py-2 mt-2 mb-2 rounded-md shadow-sm mb-border focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block w-full px-4 py-2 mt-2 mb-2 rounded-md shadow-sm mb-border focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                            type="password"
                            name="password"
